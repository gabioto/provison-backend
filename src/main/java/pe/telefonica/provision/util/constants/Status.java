...
public enum Status {
	...
	PENDIENTE("PENDIENTE", 1, "PRE REGISTRADO",
			"[$name], el servicio Hogar de tu pedido MT está en proceso de atención y la instalación se realizará el (indicar día) y (indicar nombre)",
			"[$name], el servicio Hogar de tu pedido MT está en proceso de atención y será entregado en un máximo de 7 días desde que realizaste tu solicitud."),
	...
	WO_NOTDONE("WO_NOTDONE", 13, "PEDIDO NO INSTALADO",
			"[$name], hemos cancelado tu pedido debido a que no contamos con las facilidades de conectividad en tu zona para la instalación. Lamentamos los inconvenientes.",
			""),
