...
public final class Constants {
	...
	public static final Map<String, String> ATIS_COMMERCIAL_OP = Stream.of(new String[][] {
			...
			{ "ALTA MIGRACION", "MIGRACION ATIS" },
			{ "ALTA MIGRACION TRASLADO CIS", "MIGRACION ATIS" },
			{ "ALTA MIGRACION TRASLADO SIS", "MIGRACION ATIS" },
			{ "MODIFICACION", "MIGRACION ATIS" },
			{ "MODIFICACION DE CARACTERISTICAS DE P/S", "MIGRACION ATIS" },
			{ "ALTA MIGRACION DE P/S", "MIGRACION ATIS" }
	})
			.collect(Collectors.toMap(data -> data[0], data -> data[1]));
