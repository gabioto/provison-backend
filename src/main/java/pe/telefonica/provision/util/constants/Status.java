...
public enum Status {
	...
	CAIDA("CAIDA", 3, "CANCELADO",
			"Hola [$name], tu pedido ha sido cancelado, lamentamos el inconveniente. Por favor comunicate al 080011800 para reingresar tu pedido",
			""),
	...
	IN_TOA("IN_TOA", 5, "REGISTRADO OPCIÓN A AGENDAR",
			"Hola [$name], estamos atendiendo tu pedido. Puedes hacer seguimiento desde nuestra App Hogar en Android o IOS",
			"Hola [$name], falta agendar tu pedido. Puedes realizarlo desde nuestra App Hogar"),
	WO_PRESTART("WO_PRESTART", 6, "REGISTRADO TÉCNICO EN CAMINO",
			"Hola [$name], tu técnico está en camino, puedes hacer el seguimiento desde nuestra app Movistar Hogar",
			""),
	WO_INIT("WO_INIT", 7, "REGISTRADO TÉCNICO EN CASA",
			"Hola [$name], tu pedido se está instalando. Puedes hacer el seguimiento desde la app Movistar Hogar", ""),
	WO_COMPLETED("WO_COMPLETED", 8, "INSTALACIÓN EXITOSA", "Hola [$name], tu pedido se instaló con éxito", ""),
	SCHEDULED("SCHEDULED", 9, "REGISTRADO OPCIÓN A REAGENDAR",
			"Hola [$name], tu pedido está en evaluación. Puedes hacer seguimiento desde nuestra app Movistar Hogar",
			""),
	...
	WO_CANCEL("WO_CANCEL", 11, "AGENDA CANCELADA",
			"Hola [$name], tu cita para la instalación de tu pedido fue cancelada, lamentamos el inconveniente.", ""),
	...
	CANCEL("CANCEL", 14, "CANCELADO POR CLIENTE",
			"Hola [$name], la solicitud de cancelación de tu pedido Movistar se realizo con éxito. [Si el cliente menciona que él no solicitó la cancelación, sigue flujo regular de reingreso de pedido]",
			"");
